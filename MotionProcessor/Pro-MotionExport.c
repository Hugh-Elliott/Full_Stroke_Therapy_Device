...
#include "C-Motion.h" #include "c-Motion.h"
#include "PMDdiag.h"
#include "PMDsys.h"
#include "PMDutil.h"

// N-Series ION DD481C0056/06
...
PMDprintf("Pizza pie\r\n");
  ...
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKp, 0))
  ...
  PMD_RESULT(PMDSetCurrentFoldback (phAxis, PMDCurrentFoldbackContinuousCurrentLimit, 8106))
  PMD_RESULT(PMDSetCurrentFoldback (phAxis, PMDCurrentFoldbackI2tEnergyLimit, 502))
