...
PMDresult result = PMD_NOERROR;
  ...
  PMD_RESULT(PMDSetPositionErrorLimit (phAxis, 2147483647))
  PMD_RESULT(PMDSetSettleTime (phAxis, 2000))
  PMD_RESULT(PMDSetSettleWindow (phAxis, 5)) //Previously 1
  PMD_RESULT(PMDSetTrackingWindow (phAxis, 0))
  PMD_RESULT(PMDSetEncoderSource (phAxis, 0))
  PMD_RESULT(PMDSetGearMaster (phAxis, 0, 0))
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKp, 200))
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKi, 150))
  ...
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKout, 32768))
  ...
  PMD_RESULT(PMDSetMotorLimit (phAxis, 2730)) // Previously 2730
  PMD_RESULT(PMDSetMotionCompleteMode (phAxis, 0)) // Previously 1
  PMD_RESULT(PMDSetSignalSense (phAxis, 0x1000))
  PMD_RESULT(PMDSetCaptureSource (phAxis, 1)) // Previously 0
  PMD_RESULT(PMDSetCommutationParameter (phAxis, PMDCommutationParameterPhaseDenominator, 2))
  PMD_RESULT(PMDSetCommutationMode (phAxis, 0))
  PMD_RESULT(PMDSetPhaseCorrectionMode (phAxis, 0))
  PMD_RESULT(PMDSetPhaseInitializeMode (phAxis, 1))
  ...
  PMD_RESULT(PMDSetFOC (phAxis, 2, 0, 300))
  PMD_RESULT(PMDSetFOC (phAxis, 2, 1, 200))
  ...
  PMD_RESULT(PMDSetEventAction (phAxis, PMDEventActionEventPositiveLimit, 0x0008)) // I eddited from 0x0000
  PMD_RESULT(PMDSetEventAction (phAxis, PMDEventActionEventNegativeLimit, 0x0008)) // I eddited
