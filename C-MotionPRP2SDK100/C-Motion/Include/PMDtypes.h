...
#if defined(WIN32) && (defined(PMD_EXPORTS) || defined(PMD_IMPORTS))
...
typedef enum {
        ...
        PMDSPIModeFallingEdge        = 2, // SPI mode 3  (CPOL=1, CPHA=1)  Data sampled on subsequent falling edge of the clock, clock idles high
...
typedef enum {
        ...
        PMDPhaseParameterPulseCommand                           = 3,
