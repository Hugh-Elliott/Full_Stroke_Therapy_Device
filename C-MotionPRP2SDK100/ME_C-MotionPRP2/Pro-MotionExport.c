...
{
	PMDresult result = PMD_NOERROR; PMD_RESULT(PMDSetOperatingMode(phAxis,1));
  PMDprintf("Test\r\n");
  ...
  PMD_RESULT(PMDSetPositionErrorLimit (phAxis, 1000))
  PMD_RESULT(PMDSetSettleTime (phAxis, 2000))
  PMD_RESULT(PMDSetSettleWindow (phAxis, 5))
  ...
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKi, 3))
  ...
  PMD_RESULT(PMDSetPositionLoop (phAxis, PMDPositionLoopKout, 6554))
  ...
  PMD_RESULT(PMDSetMotorLimit (phAxis, 1092))
  PMD_RESULT(PMDSetMotionCompleteMode (phAxis, 0))
  PMD_RESULT(PMDSetSignalSense (phAxis, 0x1000)) // previously 0x1000
  ...
  PMD_RESULT(PMDSetEventAction (phAxis, PMDEventActionEventPositiveLimit, 0x0008))// I edited from 0x0000
  PMD_RESULT(PMDSetEventAction (phAxis, PMDEventActionEventNegativeLimit, 0x0008))// I edited
